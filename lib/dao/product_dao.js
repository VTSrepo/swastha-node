    ...
    GetProductDetail(connection, product_id) {
        return new Promise(async(resolve, reject)=> {
            try{
                ...
                var custQuery = `SELECT p.*,s.product_price,concat(a.product_name,' - ', b.product_price) as product_name_price,b.patient_price, b.insurance_price, b.doctor_price FROM ${process.env.WRITE_DB_DATABASE}.Product_Master p INNER JOIN 
